...
from blog.views import  posts_list, create_post, post_detail, post_delete, post_update, comment_create, comment_update, comment_delete
urlpatterns = [
    ...
    path('comment_create/', comment_create),
